...
export const SubscriptionPlanDropdown = ({
    ...
    return (
        ...
        //     </DropdownMenu>
        // </div>
        <div className={`flex flex-col outline-none w-full justify-center items-center space-y-2 ${theme === "dark" ? "bg-[#383838]" : "bg-zinc-100"} rounded-lg shadow-custom-3 p-4 border`} style={{ borderColor: color }}>
            <Zap className="w-6 h-6" style={{ stroke: color, fill: color }} />
            <span className="text-[13px] font-medium text-center">Ready to go to the next level?</span>
            <Button
                onClick={onClick}
