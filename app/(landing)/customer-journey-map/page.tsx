    ...
    return ( 
        <div>
            ...
            <BlogSection 
                    ...
                    text="El principal objetivo al usar customer journey maps es mejorar la experiencia del cliente. Estas herramientas permiten comprender profundamente las necesidades y emociones de los clientes en cada etapa de su interacción con la marca, lo que facilita la identificación de puntos de mejora."
