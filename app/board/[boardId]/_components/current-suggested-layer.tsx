...
interface SuggestedLayerProps {
    layer: any;
};


export const CurrentSuggestedLayer = memo(({
    layer,
}: SuggestedLayerProps) => {

    // if (layer.fill) {
    //     layer.fill = { r: layer.fill.r, g: layer.fill.g, b: layer.fill.b, a: 0.5 };
    // }
    
    if (layer.outlineFill) {
        layer.outlineFill = { r: layer.outlineFill.r, g: layer.outlineFill.g, b: layer.outlineFill.b, a: 0.5 };
    }
...
CurrentSuggestedLayer.displayName = "currentLayerPreview";