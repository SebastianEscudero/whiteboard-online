    ...
    return (
        <div className="relative text-left border-neutral-200 flex justify-center">
            ...
            {openSelector === SelectorType.TextJustify && (
                <div className={`p-3 absolute ${selectorPositionClass} left-1/2 transform -translate-x-1/2 w-[140px] rounded-lg shadow-custom-1 bg-white dark:bg-[#1A1A1C] ring-1 ring-black ring-opacity-5`}>
