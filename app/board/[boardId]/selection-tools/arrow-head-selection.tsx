    ...
    return (
        <div className="relative inline-block text-left pl-1">
            ...
            {openSelector === SelectorType.ArrowHead && (
                <div
                    className={`shadow-custom-1 rounded-lg absolute ${selectorPositionClass} ${selectedHead === 'start' ? 'left-[-10px]' : 'right-[-10px]'} w-[75px] bg-white dark:bg-[#383838] ring-1 ring-black ring-opacity-5`}
                >
