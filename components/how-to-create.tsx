...
export const HowToCreate = ({
    ...
    return (
        <div className={`bg-[#fff] rounded-lg border border-black xl:mx-[10%] lg:mx-[7%] md:mx-[5%] mx-[5%] text-[#1c1c1e] p-4 font-light`}>
            ...
            <Accordion type="single" collapsible className="bg-white p-5 rounded-lg">
                {steps.map(item => (
                    <AccordionItem value={item.trigger} key={item.trigger}>
                        <AccordionTrigger className="my-3 text-lg md:text-xl xl:text-2xl font-light">{item.trigger}</AccordionTrigger>
