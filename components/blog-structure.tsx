...
export const BlogStructure = ({
    ...
    return (
        <div className={`text-[#1c1c1e] pt-20 md:pt-24 lg:pt-28 xl:pt-32 flex flex-col md:flex-row md:space-x-10 xl:space-x-20 font-roobert ${img ? "xl:mx-[10%] lg:mx-[7%] md:mx-[5%] mx-[5%] items-center md:text-left text-center" : "lg:mx-[25%] md:mx-[15%] mx-[5%] text-center space-y-5"}`}>
