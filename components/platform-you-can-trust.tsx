    ...
    return (
        <div className="xl:mx-[10%] lg:mx-[7%] md:mx-[5%] mx-[5%] font-roobert">
            <div className="text-center mb-10 mx-5">
                <h2 className="text-3xl sm:text-4xl lg:text-5xl mb-5 text-black dark:text-white">
            ...
            <div className="bg-[#FFF] dark:bg-[#020817] p-4 lg:pb-5 pb-5 border border-zinc-500 dark:border-zinc-200 rounded-lg">
                <div className="py-3">
                    <div className="grid grid-cols-1 grid-rows-2 lg:grid-cols-2 rounded-lg my-4">
                        <div className="md:p-7 py-6 m-2 rounded-md">
                            ...
                            <p className="text-zinc-700 dark:text-zinc-300 text-lg md:text-xl">
