...
export const PlatformYouCanTrust = () => {
    return (
            <div className="bg-[#FFF] lg:p-16 lg:pb-5 pb-5 p-10 border border-zinc-500 rounded-lg xl:mx-[20%] mx-[2%] lg:mx-[5%]">
                ...
                <div className="p-3">
                    <div className="grid grid-cols-1 grid-rows-2 lg:grid-cols-2 border rounded-lg my-4">
                        <div className="p-7 m-2 rounded-md">
                            <h1 className="text-2xl flex items-center font-semibold mb-1">   
                                <GaugeCircle className="mr-2 text-pink-500"/>
                                99.99% de tiempo de actividad
                            </h1>
                            <div className="text-zinc-700 text-xl md:text-xl font-normal">
